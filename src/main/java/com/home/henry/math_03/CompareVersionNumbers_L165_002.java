 ...
 *
 * Example 1: Input: version1 = "0.1", version2 = "1.1" Output: -1 Example 2:
 ...
 *
 * Example 5: Input: version1 = "1.0", version2 = "1.0.0" Output: 0
 ...
 * Note:
 *
 * Version strings are composed of numeric strings separated by dots . and this numeric
 * strings may have leading zeroes.
 * Version strings do not start or end with dots, and they will not be two consecutive dots.
 */
public class CompareVersionNumbers_L165_002 {
    ...
    static class Solution {
        ...
        public int compareVersion(String version1, String version2) {
            ...
            for (int i = 0; i < length; i++) {
                // the API for Integer.valueOf(String) does indeed say that the
                // String is interpreted exactly as if it were given to{Integer.parseInt(String)}.
                // However, valueOf(String) returns a new Integer() object whereas parseInt(String)
                // returns a primitive int. Credit: Stack Overflow
